...
<html>
    <head>
        ...
        <style>
            ...
            */
            .jssorb21 div, .jssorb21 div:hover, .jssorb21 .av {
                background: url(../public/slide/img/b21.png) no-repeat;
                overflow: hidden;
                cursor: pointer;
            }
        ...
        <style>
            ...
            */
            .jssora21l, .jssora21r, .jssora21ldn, .jssora21rdn {
                ...
                cursor: pointer;
                display: block;
                background: url(../public/slide/img/a21.png) center center no-repeat;
                overflow: hidden;
            }
        ...
        {!! HTML::script('slide/js/jssor.js') !!}
        {!! HTML::script('slide/js/jssor.slider.js') !!}
    ...
    <body style="padding:0px; margin:0px; font-family:Arial, Verdana;background-color:#fff;">
       ...
       <ul class="nav nav-pills nav-tabs">
            ...
            <li role="presentation" class='active'>{!! HTML::link('#','Front End',['target' => '_blank']) !!}</li>   
        </ul>
        <div id="slider1_container" style="position: relative; margin: 0 auto;
            ...
            <div data-u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1300px;
                ...
                <div>
                    <img data-u="image" src="../public/images/{!!$banner['image'] !!}" alt="" />
                    <div style="position: absolute; width: 480px; height: 120px; top: 30px; left: 30px; padding: 5px;
                         text-align: left; line-height: 60px; text-transform: uppercase; font-size: 50px;
                         color: white;">{!! $banner['name'] !!} Banner
                    </div>
                ...
                @endforeach
                @else
                <center><p style="margin-top:100px;">no data!</p></center>
                @endif
            </div>
